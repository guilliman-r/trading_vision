...
- [ ] **TV-0204 — P0 / XS:** Validate intervals, timezones, positive polling values, and score ranges at startup.
...
- [ ] **TV-0508 — P0 / S:** Remove or flag the still-open candle based on interval and exchange session.
...
- [ ] **TV-0511 — P0 / S:** Log request duration and returned candle range without logging secrets.
- [ ] **TV-0512 — P0 / S:** Add a small in-process cooldown to avoid repeated identical requests from UI callbacks.
...
- [ ] **TV-1714 — P1 / S:** Add dependency-update and security-audit cadence.
...
- [ ] **TV-1804 — P0 / S:** Display the application version and database schema version.
